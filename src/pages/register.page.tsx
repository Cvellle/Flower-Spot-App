...
const registerSchema = object({
  ...
  lastName: string().min(1, "Full name is required").max(100),
  dateOfBirth: string().min(1, "Full name is required").max(100),
  email: string()
        ...
        <div className="w-full">
          ...
          <FormProvider {...methods}>
            ...
            >
              ...
              <FormInput label="date" name="dateOfBirth" type="date" />
